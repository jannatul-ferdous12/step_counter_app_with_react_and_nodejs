...
```
cd existing_repo
git remote add origin https://gitlab.tamk.cloud/tamk-projects/summer-projects/2022/023-server-data-maintenance-web-service-and-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.tamk.cloud/tamk-projects/summer-projects/2022/023-server-data-maintenance-web-service-and-api/-/settings/integrations)
